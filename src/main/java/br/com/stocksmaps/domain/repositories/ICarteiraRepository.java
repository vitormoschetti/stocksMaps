...
public interface ICarteiraRepository extends IRepository<CarteiraModel>, ICriar<Carteira, Carteira>, IBuscarPorId<Carteira, Long>, IAtualizar<Carteira, Carteira> {
